...
const TEXT = {
  ...
  info: {
    ...
    supportedDesc: 'PDF 문서, PNG/JPG 세금계산서 이미지',
    limitsTitle: '제한사항',
    limitsDesc: '최대 10MB 파일 크기. 수기 세금계산서는 추출 정확도가 낮을 수 있습니다.',
  },
}

const steps = [
  { num: 1, title: 'AI가 데이터 추출', desc: 'AI가 문서를 읽고 주요 필드를 추출합니다.' },
  { num: 2, title: '사용자가 검토 및 수정', desc: '추출된 값을 검토하고 오류를 수정합니다.' },
  { num: 3, title: '규칙이 검증', desc: '결정론적 코드 기반 규칙이 최종 검증 결정을 내립니다.' },
]
  ...
  return (
    <div className="min-h-screen bg-background p-8">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-lg">{TEXT.howItWorks.title}</CardTitle>
            <CardDescription>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="border-2 border-dashed border-border rounded-lg p-12 text-center">
              ...
              <Button variant="outline">{TEXT.upload.selectButton}</Button>
            </div>
